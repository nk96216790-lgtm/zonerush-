...
let tasks=[
{id:1,title:"Welcome to ZONERUSH",desc:"Admin se jo Poster banayega yahi dikhega. Isko Delete kar sakta hai.",prize:"500 ZC",img:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=400"}
];
app.get('/',(req,res)=>{
...
.bottom{position:fixed;bottom:8px;left:8px;right:8px;display:flex;justify-content:space-around;background:#0c132ce6;border-radius:20px;padding:8px;z-index:99}
